<%@ Page  Title="UpdateUserEntry" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateUserEntry.aspx.cs" Inherits="TrackItWeb.UpdateUserEntry" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () { 
            ...
            ProjectTime.showHideQuickEditButton()
        });      
        
        var ProjectTime = {
            showHideQuickEditButton: function () {
                if ($(".save").length == 1) {
                    $("#QuickEdit").show()
                }
                else {
    ...
    <div class="container-fluid Maindiv">        
         <div>
            ...
            <asp:DropDownList ID="lstUser" AutoPostBack="true" runat="server"  OnTextChanged="lst_SelectedIndexChanged" CssClass="ListBoxCSS"></asp:DropDownList>
        </div>
        <br />   
        <div>
            <asp:Label ID="lblPeriod" runat="server" Text="Date"/>
