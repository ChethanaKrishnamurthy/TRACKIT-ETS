<%@ Page  Title="ManagerUpdateUserEntry" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManagerUpdateUserEntry.aspx.cs" Inherits="TrackItWeb.ManagerUpdateUserEntry" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    <asp:GridView class="modal-content" style ="text-align:left" ID="tblProjects" runat="server" AutoGenerateColumns="false">
                        <Columns>
    ...
    <div class="container-fluid Maindiv">        
         <div>
            <asp:Label ID="lblUser" runat="server" Text="User" Font-Bold="True" style="padding-right:8px;font-size:18px"/>
            <asp:DropDownList ID="lstUser" AutoPostBack="true" runat="server"  OnTextChanged="lst_SelectedIndexChanged" CssClass="txtsdate"></asp:DropDownList>
        </div>
        <br />   
        <div>
            <asp:Label ID="lblPeriod" runat="server" Text="Date" Font-Bold="True"  style="padding-right:8px;font-size:18px"/>
            <asp:TextBox CssClass="txtsdate" ID="txtsdate" runat="server" AutoCompleteType="Disabled" AutoPostBack="true" OnTextChanged="txtsdate_TextChanged"></asp:TextBox>
        </div>
         ...
         <div style="padding-bottom: 5px">
            ...
            <button ID= "btnPjtCode" type="button" class="btn btn-info btn-lg modalbtn" data-toggle="modal" data-target="#projectCodeModal">Project Code Info</button>           
         </div>
      <br />
       
   <asp:ListView ID="ListViewEntry" runat="server" OnItemDataBound="ListViewEntry_ItemDataBound" GroupPlaceholderID="groupPlaceHolder1" ItemPlaceholderID="itemPlaceHolder1">
    <LayoutTemplate>
       <table id="table1" class="table">
        ...
        <GroupTemplate>
         ...
         <div style="float:right;margin-right:67px;">
            <asp:Label style ="font-weight: bold" ID="lblTotalPer" runat="server" Text="Total %"/>
